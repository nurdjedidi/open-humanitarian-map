...
export const messages = {
  fr: {
    ...
    demo: {
      ...
      viewModeFlat: "Vue d'ensemble",
      viewModeFlatDesc: "Lecture plane et stable à grande échelle",
      viewMode3d: "3D",
      viewMode3dDesc: "Zoom fort et bâtiments extrudés si disponibles",
      droneMode: "Drone",
      droneModeDesc: "Vue inclinée et zoom rapproché. Peut se combiner avec le mode 3D.",
      populationMode: "Mode population",
      populationModeDesc: "Lecture dérivée du raster population. Le glow montre les concentrations larges, puis les points prennent le relai au zoom.",
      ipcPhaseMode: "Population par phase IPC",
      ipcPhaseModeDesc: "Agrégation par pays sur l'année active. P3+ = IPC 3 + IPC 4 + IPC 5.",
      alertPanelBadge: "Afrique · Signal faim",
      alertPanelTitle: "3 pays les plus en danger",
      alertKeyData: "Donnée phare",
      alertP3PlusContext: "personnes en phase IPC 3+ sur la référence active par pays",
      alertTotalPop: "Population totale couverte",
      alertLoadingTitle: "Brief famine en préparation",
      alertLoadingBody: "On charge les couches admin détaillées pour calculer les totaux IPC par phase sans afficher de faux zéros.",
      alertReference: "Référence",
      alertActiveRefByCountry: "Référence active selon pays",
      alertActiveRefSingle: "Référence active {year}",
      alertActiveRefRange: "Références actives {start}-{end} selon pays",
      ngoPresence: "Présence ONG (3W)",
      ngoReportingPeriod: "Période de reporting",
      ngoSinglePeriod: "Une seule période disponible",
    },
    info: {
  ...
  en: {
    ...
    demo: {
      ...
      analysis: "Analysis",
      viewMode: "View mode",
      viewModeFlat: "Overview",
      viewModeFlatDesc: "Flat and stable reading at large scale",
      viewMode3d: "3D",
      viewMode3dDesc: "High zoom and extruded buildings if available",
      droneMode: "Drone",
      droneModeDesc: "Tilted view and close zoom. Can be combined with 3D mode.",
      populationMode: "Population mode",
      populationModeDesc: "Reading derived from population raster. Glow shows wide concentrations, then points take over at zoom.",
      ipcPhaseMode: "Population by IPC phase",
      ipcPhaseModeDesc: "Aggregation by country for the active year. P3+ = IPC 3 + IPC 4 + IPC 5.",
      alertPanelBadge: "Africa · Hunger signal",
      alertPanelTitle: "3 most at-risk countries",
      alertKeyData: "Key data",
      alertP3PlusContext: "people in IPC phase 3+ on active reference by country",
      alertTotalPop: "Total population covered",
      alertLoadingTitle: "Famine brief in progress",
      alertLoadingBody: "Loading detailed admin layers to calculate IPC totals per phase without displaying false zeros.",
      alertReference: "Reference",
      alertActiveRefByCountry: "Active reference by country",
      alertActiveRefSingle: "Active reference {year}",
      alertActiveRefRange: "Active references {start}-{end} by country",
      ngoPresence: "NGO Presence (3W)",
      ngoReportingPeriod: "Reporting period",
      ngoSinglePeriod: "Only one period available",
    },
    info: {
