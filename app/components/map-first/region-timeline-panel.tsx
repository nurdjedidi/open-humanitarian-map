...
export function RegionTimelinePanel({
  ...
  return (
    <aside className="pointer-events-auto absolute bottom-24 left-4 z-[45] w-[360px] max-w-[calc(100vw-32px)] rounded-[26px] border border-white/10 bg-[#0a1420]/94 p-4 shadow-[0_24px_80px_rgba(2,6,12,0.38)] backdrop-blur-xl md:bottom-8">
